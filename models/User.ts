...
export interface IUserDocument extends Document {
    ...
    // ── Website builder ──────────────────────────────────────────────────────
    /**
     * The subdomain chosen by the user for their built site.
     * e.g. "john" → john.yourdomain.com
     * Must be unique, lowercase, alphanumeric + hyphens only.
     * Auto-generated from name on first publish if not set.
     */
...
const UserSchema = new Schema<IUserDocument>(
    {
        ...
        siteSubdomain: {
            ...
            lowercase: true,
            trim: true,
            match: /^[a-z0-9-]{2,40}$/, // only lowercase alphanumeric + hyphens
        },
