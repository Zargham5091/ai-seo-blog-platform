...
//         role: "member" | "editor" | "admin";
//         joinedAt: Date;
//         aiCreditsAllocated: number;  // how many of owner's credits this member can use
//         aiCreditsUsed: number;       // how many they've used
//     }[];
//     pendingInvites?: {
//         email: string;
//         role: "member" | "editor" | "admin";
...
// UserSchema.index({plan: 1});
// UserSchema.index({stripeCustomerId: 1});
// UserSchema.index({"teamMembers.userId": 1}); // ← needed for getTenantContext lookup
//
// const UserModel: Model<IUserDocument> =
//     mongoose.models.User ?? mongoose.model<IUserDocument>("User", UserSchema);
//
...
//     gscConnectedAt?: Date;
//     gscSiteUrl?: string;
//     teamMembers?: { userId: mongoose.Types.ObjectId; role: string; joinedAt: Date }[];
//     pendingInvites?: { email: string; role: string; token: string; expiresAt: Date }[];
// }
//
// const UserSchema = new Schema<IUserDocument>(
//     {
